...
for risk_reward_ratio in risk_reward_ratios:
    for pair in pairs:
        ...
        df_last_100_daily = df_daily.tail(4000)
        ...
        df_last_100_5min = df_5min.tail(900000)
        ...
        def calculate_metrics(trade_results_df):
            ...
            metrics = {
                ...
                'Long Position Net Result': f"${long_net_result} / {long_win_percentage}%",
                'Short Position Net Result': f"${short_net_result} / {short_win_percentage}%",
        ...
        trade_results_df.to_csv(
            f'/Users/mac/Desktop/forex_back_test/results/{pair}/backtest_results_{risk_reward_ratio}_{pair}.csv', index=False)
